        ...
        <div class="col-12 col-lg-12">
            <div class="card shadow">
                <div class="card-body">
                    <div class="row">
                        <div class="col-12">
                            <h5>Dashboard Operator Temuan</h5>
                        </div>
                        <div class="col-12">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox" value="{{ $item->id }}" name="check_duedate" id="check_duedate">
                                                      </div>
                                                </td>
                                                @endif
            ...
            <div class="modal-body p-5">
                <form action="{{ route ('import.operator.temuan') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="date" id="due_date" name="due_date" class="form-control" aria-describedby="due_date">
                    </div>
                    <div class="mb-3">
